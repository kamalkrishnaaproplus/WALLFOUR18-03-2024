...
function ajaxIndicatorStart(text="") {
    ...
    if ($('body').find('#resultLoading').attr('id') != 'resultLoading') {
        ...
        $('body').append('<div id="resultLoading" style="display:none"><div style="font-weight: 700;"><img src="' + basepath + '/assets/admin/images/ajax-loader.gif"><div id="divProcessText">'+text+'</div></div><div class="bg"></div></div>');
    }
    $('#resultLoading').css({
        'width': '100%',
        'height': '100%',
