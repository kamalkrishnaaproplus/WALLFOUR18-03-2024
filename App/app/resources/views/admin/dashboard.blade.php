...
<link rel="stylesheet" type="text/css" href="{{url('/')}}/assets/admin/css/rating.css">
			...
			<div class="col-lg-6">
				<ol class="breadcrumb">
					<li class="breadcrumb-item">
						<a href="index.html"><i class="f-16 fa fa-home"></i></a>
					</li>
...
<script src="{{url('/')}}/assets/admin/js/rating/jquery.barrating.js"></script>
<script src="{{url('/')}}/assets/admin/js/rating/rating-script.js"></script>
<script>
