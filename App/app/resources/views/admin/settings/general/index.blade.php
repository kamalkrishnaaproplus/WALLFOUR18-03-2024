                                ...
                                <div class="tab-pane fade " id="pills-map" role="tabpanel" aria-labelledby="pills-map-tab">
                                    <div class="row d-flex justify-content-center mb-10">
                                        <div class="col-sm-3 col-11">
                                            <div class="checkbox checkbox-info"><input @if($Company['goole-map-status']) checked @endif id="chkEmbedMap" type="checkbox" ><label for="chkEmbedMap">Show Google Map</label></div>
                                        </div>
                                    </div>
                                    <div class="row mapStatus" style="@if($Company['goole-map-status']==false) display:none @endif">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="">Google  Embed Map Url <span class="required"> * </span></label>
                                                <input type="url" class="form-control" id="txtMapEmbedUrl" value="{{$Company['goole-embed-map']}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mapStatus" style="@if($Company['goole-map-status']==false) display:none @endif">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <iframe id="google-map" src="{{$Company['goole-embed-map']}}" width="100%" height="450" class="b-r-10 shadow-sm" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function(){
        ...
        const getData=()=>{
            ...
            if(activeTab=="pills-map-tab"){
                ...
                formData.append('goole-map-status',enableStatus);
                formData.append('goole-embed-map',$('#txtMapEmbedUrl').val());
