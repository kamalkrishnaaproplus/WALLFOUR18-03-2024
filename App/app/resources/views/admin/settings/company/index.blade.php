					...
					<div class="card">
						...
						<div class="card-body " >
                            ...
                            <div class="row ">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="txtCEmail">E-Mail <span class="required"> * </span></label>
                                        <input type="email" class="form-control" id="txtCEmail" value="{{$Company['E-Mail']}}">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="txtCPhoneNumber">Phone Number </label>
...
<script>
    $(document).ready(function(){
        ...
        const getData=()=>{
            ...
            formData.append('E-Mail',$('#txtCEmail').val());
