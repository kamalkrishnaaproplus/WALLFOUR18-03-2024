						...
						<div class="card-header text-center">
							<div class="form-row align-items-center">
								...
								<div class="col-md-4 my-2 text-right text-md-right">
									@if($crud['view']==1)
										<a href="{{ url('/') }}/admin/users-and-permissions/users/" class="btn  btn-outline-dark btn-sm  mr-10" type="button" >Back</a>
									@elseif($crud['add']==1)
										<a href="{{ url('/') }}/admin/users-and-permissions/users/create" class="btn  btn-outline-success btn-sm btn-air-success " type="button" >Back</a>
									@endif
								</div>
							</div>
						</div>
