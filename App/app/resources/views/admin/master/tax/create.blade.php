                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtTaxName" value="<?php if($isEdit==true){ echo $EditData[0]->TaxName;} ?>">
                                        <div class="errors err-sm" id="txtTaxName-err"></div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="txtPercentage"> Percentage <span class="required"> * </span></label>
                                        <input type="number" step="0.01" class="form-control" id="txtPercentage" value="<?php if($isEdit==true){ echo $EditData[0]->TaxPercentage;} ?>">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    @if($crud['view']==1)
                                        <a href="{{ url('/') }}/admin/master/tax" class="btn btn-sm btn-outline-dark mr-10">Cancel</a>
                                    @endif
    ...
    $(document).ready(function(){
        const formValidation=()=>{
            ...
            if(TaxName==""){
                ...
                $('#Percentage-err').html('TaxName  must be greater than 2 characters');status=false;
        ...
        $('#btnSave').click(function(){
            ...
            if(status){
                swal({
                    ...
                    @if($isEdit==true)
                        postUrl="{{url('/')}}/admin/master/tax/edit/{{$TaxID}}";
                    @endif
                    $.ajax({
                        type:"post",
                        url:postUrl,
                        ...
                        success:function(response){
                            ...
                            if(response.status==true){
                                swal({
                                    ...
                                    @if($isEdit==true)
                                        window.location.replace("{{url('/')}}/admin/master/tax");
                                    @else
