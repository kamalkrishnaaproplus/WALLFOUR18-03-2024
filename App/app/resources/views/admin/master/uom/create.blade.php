                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder=" Code" id="txtUCode" value="<?php if($isEdit==true){ echo $EditData[0]->UCode;} ?>">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Name" id="txtUName" value="<?php if($isEdit==true){ echo $EditData[0]->UName;} ?>">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    @if($crud['view']==1)
                                        <a href="{{ url('/') }}/admin/master/unit-of-measurement" class="btn btn-sm btn-outline-dark mr-10">Cancel</a>
                                    @endif
        ...
        $('#btnSave').click(function(){
            ...
            if(status){
                swal({
                    ...
                    @if($isEdit==true)
                        postUrl="{{url('/')}}/admin/master/unit-of-measurement/edit/{{$UID}}";
                    @endif
                    $.ajax({
                        type:"post",
                        url:postUrl,
                        ...
                        success:function(response){
                            ...
                            if(response.status==true){
                                swal({
                                    ...
                                    @if($isEdit==true)
                                        window.location.replace("{{url('/')}}/admin/master/unit-of-measurement");
                                    @else
                                ...
                                if(response['errors']!=undefined){
                                    ...
                                    $.each( response['errors'], function( KeyName, KeyValue ) {
                                        var key=KeyName;
                                        if(key=="txtUCode"){$('#txtUCode-err').html(KeyValue);}
