...
<head>
    <title>{{$PageTitle}} - {{$CompanySettings['NAME']}}</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/assets/admin/css/toastr.css">
    <!-- Main jquery js -->
    <script src="{{url('/')}}/assets/home/js/vendors/jquery-v3.6.4.min.js"></script>
    <!-- bootbox JS-->
    <script src="{{url('/')}}/assets/admin/plugins/bootbox-js/bootbox.min.js"></script>
</head>
...
<body class="common-home">
            ...
            <div class="row header-inner align-items-center sub_sub_menu">
                <div class="col-xl-2 col-lg-6 col-sm-6 header-left">
                    <div id="logo"> <a href="{{url('/')}}/">
                            <img src="{{url('/')}}/{{$CompanySettings['LOGO']}}" title="Your Store" alt="Your Store" class="img-fluid">
                        </a>
                    </div>
                </div>
    ...
    <footer class="mt-45">
        <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <div class="site">
                                            ...
                                            <div class="contact_site">{{$CompanySettings['FullAddress']}}</div>
                                        </div>
                                    </li>
                                    @if($CompanySettings['Phone-Number']!="")
                                    <li>
                                        <div class="phone">
                                            <div class="contact_title"><i class="fa fa-phone" aria-hidden="true"></i></div>
                                            <div class="contact_site">+{{$CompanySettings['CallCode']}} {{$CompanySettings['Phone-Number']}}</div>
                                        </div>
                                    </li>
                                    @endif
                                    @if($CompanySettings['Mobile-Number']!="")
                                    <li>
                                        <div class="fax">
                                            <div class="contact_title"><i class="fa fa-phone"></i></div>
                                            <div class="contact_site">+{{$CompanySettings['CallCode']}} {{$CompanySettings['Mobile-Number']}}</div>
                                        </div>
                                    </li>
                                    @endif
                                    <li>
                                        <div class="email">
                                            ...
                                            <div class="contact_site"><a href="mailto:{{$CompanySettings['E-Mail']}}">{{$CompanySettings['E-Mail']}}</a></div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-sm-4 find_us_on">
                        ...
                        <div class="position-footer-right">
                            ...
                            @endif
                            @if(($CompanySettings['facebook']!="")||($CompanySettings['facebook']!="")||($CompanySettings['twitter']!="")||($CompanySettings['pinterest']!="")||($CompanySettings['youtube']!="")||($CompanySettings['linkedin']!=""))
                            <div>
                                <h2 class="toggled">find us on</h2>
                                <div class="follow-link">
                                    <div class="social-media">
                                        @if($CompanySettings['facebook']!="")<a target="_blank" href="{{$CompanySettings['facebook']}}"><i class="fa-brands fa-facebook-f"></i></a> @endif
                                        @if($CompanySettings['instagram']!="")<a target="_blank" href="{{$CompanySettings['instagram']}}"><i class="fa-brands fa-instagram"></i></a> @endif
                                        @if($CompanySettings['twitter']!="")<a target="_blank" href="{{$CompanySettings['twitter']}}"><i class="fa-brands fa-twitter"></i></a> @endif
                                        @if($CompanySettings['pinterest']!="")<a target="_blank" href="{{$CompanySettings['pinterest']}}"><i class="fa-brands fa-pinterest"></i></a> @endif
                                        @if($CompanySettings['youtube']!="")<a target="_blank" href="{{$CompanySettings['youtube']}}"><i class="fa-brands fa-youtube"></i></a> @endif
                                        @if($CompanySettings['linkedin']!="")<a target="_blank" href="{{$CompanySettings['linkedin']}}"><i class="fa-brands fa-linkedin"></i></a> @endif
                                    </div>
                                </div>
                            </div>
                            @endif
            ...
            <p class="copyright">© {{date("Y")}} Rajam Snacks - All Rights Reserved.</p>
        </div>
    </footer>
    ...
    <script src="{{url('/')}}/assets/admin/js/custom-prototype.js"></script>
