...
<html lang="en">
    ...
    <!-- Required meta tags -->
		...
		<script src="{{url('/')}}/assets/admin/js/bootstrap/bootstrap.js"></script>
		<!-- sweetalert JS-->
		...
		<!-- dropify JS-->
		<script src="{{url('/')}}/assets/admin/plugins/dropify/js/dropify.min.js?r={{date('dmyHis')}}"></script>
	</head>
	<body>
		<!-- Loader starts-->
		...
		<div class="page-wrapper">
			<div class="container-fluid p-0">
				...
				<div class="auth-bg-video">
					<video id="bgvid" poster="{{url('/')}}/assets/admin/images/other-images/coming-soon-bg.jpg" playsinline="" autoplay="" muted="" loop="">
