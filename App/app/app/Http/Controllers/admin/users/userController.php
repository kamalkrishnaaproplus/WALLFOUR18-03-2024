...
class userController extends Controller{
    ...
    public function __construct(){
		...
		$this->PageTitle="Manage Employees";
	...
	public function index(Request $req){
		if($this->general->isCrudAllow($this->CRUD,"view")==true){
			...
			return view('admin.users.users.view',$FormData);
	...
	public function restoreView(Request $req){
		if($this->general->isCrudAllow($this->CRUD,"restore")==true){
			...
			$FormData['menus']=$this->Menus;
			$FormData['crud']=$this->CRUD;
			return view('admin.users.users.trash',$FormData);
	...
	public function Create(Request $req){
		if($this->general->isCrudAllow($this->CRUD,"Add")==true){
			...
			return view('admin.users.users.user',$FormData);
		}elseif($this->general->isCrudAllow($this->CRUD,"view")==true){
			return Redirect::to('/admin/users-and-permissions/users');
		}else{
			return view('errors.403');
	...
	public function Edit(Request $req,$UserID=null){
		if($this->general->isCrudAllow($this->CRUD,"edit")==true){
			$sql="Select UI.UserID,UI.FirstName,UI.LastName,UI.DOB,UI.GenderID,UI.Address,UI.CityID,UI.StateID,UI.CountryID,UI.PostalCodeID,UI.EMail,UI.MobileNumber,U.RoleID,UI.ProfileImage,UI.ActiveStatus From tbl_user_info as UI LEFT JOIN users AS U ON U.UserID=UI.UserID";
	...
	public function Save(Request $req){
		if($this->general->isCrudAllow($this->CRUD,"add")==true){
			...
			if($req->PostalCode==$req->PostalCode1){
				$req->PostalCode = $this->general->Check_and_Create_PostalCode($req->PostalCode1,$req->Country,$req->State,$this->DocNum);
			}
	...
	public function TableView(Request $request){
		if($this->general->isCrudAllow($this->CRUD,"view")==true){
			...
			$columns = array(
                ...
                array( 'db' => 'U.Password', 'dt' => '6','formatter' => function( $d, $row ) { return '<span id="pwd-'.$row['UserID'].'">**********</span>';} ),
				array( 
						'db' => 'UI.ActiveStatus', 
						'dt' => '7',
