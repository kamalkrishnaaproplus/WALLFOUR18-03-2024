...
class dashboardController extends Controller
{
    ...
    private function getRecentServices()
    {
        ...
        $sql = "SELECT P.CreatedOn, P.ServiceID, P.ServiceName, P.Slug, P.ServiceImage, P.CID as CategoryID, C.CName as CategoryName, P.Price, P.UOM as UID, U.UCode, U.UName, P.Decimals, P.TaxID, T.TaxName, T.TaxPercentage, P.TaxType, P.HSNSAC, P.ShortDescription, P.Description, P.ActiveStatus ";
